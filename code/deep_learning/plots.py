...
# Directories
RESULT_DIR = "../../results/deep_learning"
OUTPUT_CSV_DIR = "../../results/deep_learning/averaged"
OUTPUT_PLOT_DIR = "../../results/deep_learning/plots"
...
def average_rater_data(painting, rating_type, experiment_type):
    ...
    """
    # File paths
    reg_file = f"{RESULT_DIR}/regression/{painting}_{rating_type}_{experiment_type}.csv"
    comp_file = f"{RESULT_DIR}/comparative/{painting}_{rating_type}_{experiment_type}_comparative.csv"
